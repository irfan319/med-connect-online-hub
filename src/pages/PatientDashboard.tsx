      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100 text-lg mb-4">Your health journey continues with us today</p>
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            {/* Health Metrics Cards with Neumorphism */}
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {healthMetrics.map((metric, index) => (
                <Card key={index} className="relative overflow-hidden border-0 bg-white/80 backdrop-blur-lg shadow-2xl hover:shadow-3xl transition-all duration-500 animate-scale-in group transform hover:rotate-1" style={{ animationDelay: `${index * 0.1}s` }}>
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center justify-between mb-4">
                        <div className={`p-3 rounded-2xl bg-gradient-to-br ${metric.color.includes('emerald') ? 'from-emerald-100 to-emerald-200' : 
                                      ...
                                      metric.color.includes('orange') ? 'from-orange-100 to-orange-200' : 'from-cyan-100 to-cyan-200'} shadow-inner`}>
                          <metric.icon className={`w-6 h-6 ${metric.color}`} />
                        </div>
                        <Badge className={`${metric.status === 'excellent' ? 'bg-emerald-100 text-emerald-800' : 'bg-blue-100 text-blue-800'} border-0 shadow-sm`}>
                          {metric.status}
                        </Badge>
                      </div>
            ...
            <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-lg animate-fade-slide-up">
              ...
              <CardContent>
                <div className="grid md:grid-cols-4 gap-6">
                  {[
                    { icon: Calendar, label: 'Book Appointment', color: 'from-blue-500 via-blue-600 to-purple-600', link: '/appointments' },
                    { icon: FileText, label: 'View Records', color: 'from-emerald-500 via-green-600 to-teal-600', link: '#' },
                    { icon: Pill, label: 'Medications', color: 'from-purple-500 via-indigo-600 to-blue-600', link: '#' },
                    { icon: Phone, label: 'Contact Doctor', color: 'from-orange-500 via-red-500 to-pink-600', link: '#' }
                  ].map((action, index) => (
                    <Link key={index} to={action.link}>
                      <Button className={`w-full h-24 bg-gradient-to-r ${action.color} hover:shadow-2xl hover:scale-105 transition-all duration-500 animate-scale-in group relative overflow-hidden transform hover:rotate-2`} style={{ animationDelay: `${index * 0.1}s` }}>
            ...
            {/* Upcoming Appointments with Advanced Animations */}
            <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-lg animate-fade-slide-up" style={{ animationDelay: '0.2s' }}>
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button variant="outline" size="sm" className="border-purple-200 text-purple-600 hover:bg-purple-50 shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  {upcomingAppointments.map((appointment, index) => (
                    <div key={appointment.id} className="flex items-center gap-6 p-6 rounded-2xl bg-gradient-to-r from-gray-50 via-blue-50 to-purple-50 hover:from-blue-50 hover:via-purple-50 hover:to-pink-50 transition-all duration-500 border border-gray-100 hover:border-purple-200 animate-fade-in shadow-lg hover:shadow-xl transform hover:scale-[1.02]" style={{ animationDelay: `${index * 0.1}s` }}>
                      ...
                      <div className="text-right space-y-3">
                        <Badge className={`${appointment.status === 'confirmed' ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-800'} border-0 shadow-sm`}>
                          {appointment.status}
                        </Badge>
                        <Button size="sm" className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 block shadow-md hover:shadow-lg transition-all duration-300">
                          Join Call
                        </Button>
                      </div>
                    </div>
          ...
          <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {recentActivities.map((activity, index) => (
                    <div key={activity.id} className="flex items-start gap-3 p-3 rounded-xl hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 transition-all duration-300 animate-fade-in transform hover:scale-105" style={{ animationDelay: `${index * 0.1}s` }}>
                      <div className="p-2 rounded-lg bg-gradient-to-br from-indigo-100 to-purple-100 shadow-inner">
            ...
            <Card className="border-0 shadow-2xl bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 animate-fade-slide-up" style={{ animationDelay: '0.4s' }}>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 bg-white/60 rounded-xl backdrop-blur-sm shadow-inner">
                    <p className="text-sm text-gray-700 leading-relaxed font-medium">
                      "Stay hydrated! Aim for 8 glasses of water daily to maintain optimal health and energy levels."
                    </p>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-blue-100 to-teal-100 rounded-full flex items-center justify-center shadow-md">
            ...
            {/* Emergency Contact with Pulsing Animation */}
            <Card className="bg-gradient-to-br from-red-50 via-pink-50 to-rose-50 border-red-200 shadow-2xl animate-fade-slide-up border-2" style={{ animationDelay: '0.5s' }}>
              ...
              <CardContent>
                <div className="text-center space-y-4">
                  <div className="p-4 bg-gradient-to-br from-red-100 to-pink-100 rounded-2xl shadow-inner">
                    <p className="text-red-600 font-bold text-2xl mb-1">
                      +1 (555) 911-HELP
                    </p>
                    <p className="text-red-600 text-sm font-medium">24/7 Emergency Line</p>
                  </div>
                  <Button className="w-full bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 animate-pulse-gentle shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
